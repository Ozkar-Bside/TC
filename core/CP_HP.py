...
Con base en este texto funcional, genera una tabla Markdown con los casos de prueba "Happy Path". 
...
def main():
    ...
    ruta_csv = "casos_de_prueba_HP.csv"  # Archivo donde se guardarán los casos de prueba generados
